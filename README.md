...
Opus 48 kbps preview MP3s for the **ganjo** sample library.
...
- **Files**: 61 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/ganjo`](https://github.com/zulfikarbarbora-outl/ganjo)
- **Branch**: `main`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/ganjo-opus-48/main/<filename>.opus
```
